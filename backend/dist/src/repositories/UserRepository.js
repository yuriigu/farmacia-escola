        ...
        return Prisma_1.prisma.$transaction(async (tx) => {
            ...
            if (data.birthDate) {
                ...
                if (data.address) {
                    ...
                    if (data.role === Enums_1.Role.PACIENTE) {
                        shouldCreatePatient = true;
                    }
                    else {
    ...
    async update(id, data) {
        return Prisma_1.prisma.$transaction(async (tx) => {
            ...
            if (data.registerDoc !== undefined)
                userUpdateData.registerDoc = data.registerDoc;
            if (data.phone !== undefined)
                userUpdateData.phone = data.phone;
            if (data.active !== undefined)
                userUpdateData.active = data.active;
            if (data.permissions !== undefined)
                userUpdateData.permissions = data.permissions;
            ...
            if (hasPatientData) {
                if (patient) {
                    ...
                    if (data.name !== undefined)
                        patientUpdateData.name = data.name;
                    if (data.phone !== undefined)
