...
class PatientController {
    ...
    create = async (req, res) => {
        try {
            ...
            const validationResult = ValidationMiddleware_1.patientCreateSchema.safeParse(req.body);
    ...
    update = async (req, res) => {
        try {
            ...
            const validationResult = ValidationMiddleware_1.patientUpdateSchema.safeParse(req.body);
            if (!validationResult.success) {
                let errorMsg = 'Dados inválidos na requisição';
                if (validationResult.error) {
                    if (validationResult.error.issues) {
