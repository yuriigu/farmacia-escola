...
export const MODULES: ModuleConfig[] = [
  ...
  },
  {
    ...
    label: 'Calendário',
    icon: Calendar,
    permission: 'appointmentsOverview',
    tabs: [
      { id: 'agenda', label: 'Agenda e Escala', icon: CalendarDays, permission: 'appointmentsOverview' },
      { id: 'agendamentos', label: 'Agendamentos de Retirada', icon: Calendar, permission: 'appointments' },
    ],
    defaultTab: 'agenda',
    actionLabels: {
      agenda: '',
